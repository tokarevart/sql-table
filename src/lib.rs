...
macro_rules! table {
    ...
    (
        ...
        paste::paste! {
            ...
            impl table::TableColumn for [<$name Column>] {
                type Table = $name;
            ...
            impl table::Unquote for [<Unquoted $name>] {
                type Target = [<Unquoted $name>];
                fn unquoted(self) -> Self::Target {
                    [<Unquoted $name>]
                }
            ...
            impl table::TableColumn for [<Unquoted $name Column>] {
                type Table = [<Unquoted $name>];
                const TABLE: [<Unquoted $name>] = [<Unquoted $name>];
                const QUOTE: &'static str = "";
            }

            impl table::Unquote for [<$name Column>] {
            ...
            impl table::Unquote for [<Unquoted $name Column>] {
                type Target = Self;
